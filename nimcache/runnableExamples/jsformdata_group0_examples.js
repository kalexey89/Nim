...
function auxWriteStackTrace_33556530(f_33556531) {
  ...
  var result_33556532 = [[]];
    ...
    L6: do {
      ...
      colontmp__503316514 = (i_33556541 - 1);
      var res_503316516 = colontmp__503316514;
      L7: do {
          L8: while (true) {
          if (!(0 <= res_503316516)) break L8;
            j_33556589 = res_503316516;
...
framePtr = F;
F.line = 7;
var data_503316481 = new FormData();
F.line = 8;
data_503316481.set("key0", "value0");
F.line = 9;
data_503316481.append("key1", "value1");
F.line = 10;
data_503316481.delete("key1");
if (!(data_503316481.has("key0"))) {
F.line = 11;
...
if (!((data_503316481.get("key0") == "value0"))) {
F.line = 12;
...
F.line = 13;
(() => { const frmdt = data_503316481; Array.from(frmdt.keys()).forEach((key) => frmdt.delete(key)) })();
if (!((Array.from(data_503316481.entries()).length == 0))) {
F.line = 14;
