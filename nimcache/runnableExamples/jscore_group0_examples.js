...
var NTI503316514 = {size: 0,kind: 31,base: null,node: null,finalizer: null};
var NTI503316523 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
var NNI503316523 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "a", len: 0, typ: NTI503316514, name: "a", sons: null}, 
...
function HEX2EHEX2E_503316514(a_503316517, b_503316518) {
  var result_503316521 = ({a: 0, b: 0});

  var F={procname:".....",prev:framePtr,filename:"/home/runner/work/Nim/Nim/lib/system.nim",line:0};
  framePtr = F;
    F.line = 507;
    result_503316521 = nimCopy(result_503316521, {a: a_503316517, b: b_503316518}, NTI503316523);
  framePtr = F.prev;

  return result_503316521;
...
function auxWriteStackTrace_33556530(f_33556531) {
  ...
  var result_33556532 = [[]];
    ...
    L6: do {
      ...
      colontmp__503316742 = (i_33556541 - 1);
      var res_503316744 = colontmp__503316742;
      L7: do {
          L8: while (true) {
          if (!(0 <= res_503316744)) break L8;
            j_33556589 = res_503316744;
...
function HEX3DHEX3D_503316492(x_503316494, y_503316495) {
  var result_503316496 = false;

  var F={procname:"==.==",prev:framePtr,filename:"/home/runner/work/Nim/Nim/lib/system/comparisons.nim",line:0};
  framePtr = F;
  BeforeRet: do {
    F.line = 301;
    var sameObject_503316504 = false;
    F.line = 302;
    sameObject_503316504 = x_503316494 === y_503316495
    if (sameObject_503316504) {
    F.line = 303;
    result_503316496 = true;
    break BeforeRet;
    }
    
    if (!(((x_503316494).length == (y_503316495).length))) {
    F.line = 306;
    result_503316496 = false;
    break BeforeRet;
    }
    ...
    L1: do {
      ...
      var i_503316550 = 0;
      F.line = 126;
      var colontmp__503316730 = ({a: 0, b: 0});
      F.line = 308;
      colontmp__503316730 = nimCopy(colontmp__503316730, HEX2EHEX2E_503316514(0, subInt((x_503316494).length, 1)), NTI503316523);
      L2: do {
        F.line = 129;
        var x_503316736 = 0;
        F.line = 90;
        var res_503316737 = colontmp__503316730.a;
        L3: do {
          F.line = 91;
            L4: while (true) {
            if (!(res_503316737 <= colontmp__503316730.b)) break L4;
              F.line = 129;
              x_503316736 = res_503316737;
              F.line = 308;
              i_503316550 = x_503316736;
              if (!((x_503316494[chckIndx(i_503316550, 0, (x_503316494).length-1)] == y_503316495[chckIndx(i_503316550, 0, (y_503316495).length-1)]))) {
              F.line = 310;
              result_503316496 = false;
              break BeforeRet;
              }
              ...
              F.line = 93;
              res_503316737 = addInt(res_503316737, 1);
            }
        } while(false);
      } while(false);
    } while(false);
...
function HEX3DHEX3D_503316582(x_503316584, y_503316585) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      ...
      F.line = 308;
      colontmp__503316749 = nimCopy(colontmp__503316749, HEX2EHEX2E_503316514(0, subInt((x_503316584).length, 1)), NTI503316523);
      L2: do {
        F.line = 129;
        var x_503316751 = 0;
        F.line = 90;
        ...
        L3: do {
          F.line = 91;
            ...
            if (!(res_503316752 <= colontmp__503316749.b)) break L4;
              ...
              if (!((x_503316584[chckIndx(i_503316612, 0, (x_503316584).length-1)] == y_503316585[chckIndx(i_503316612, 0, (y_503316585).length-1)]))) {
              F.line = 310;
              result_503316586 = false;
              break BeforeRet;
              }
...
var F={procname:"module jscore_examples1",prev:framePtr,filename:"/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples1.nim",line:0};
framePtr = F;
if (!(HEX3DHEX3D_503316492([97, 98, 99, 100, 101].copyWithin(0, 3, 4), [100, 98, 99, 100, 101]))) {
F.line = 7;
...
if (!(HEX3DHEX3D_503316492([97, 98, 99, 100, 101].copyWithin(1, 3), [97, 100, 101, 100, 101]))) {
F.line = 8;
...
if (!(HEX3DHEX3D_503316582(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2), [1, 2, 3, 1, 2]))) {
F.line = 9;
...
if (!(HEX3DHEX3D_503316582(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3), [4, 5, 3, 4, 5]))) {
F.line = 10;
...
if (!(HEX3DHEX3D_503316582(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3, 4), [4, 2, 3, 4, 5]))) {
F.line = 11;
...
if (!(HEX3DHEX3D_503316582(new Int32Array([1, 2, 3, 4, 5]).copyWithin(-2, -3, -1), [1, 2, 3, 3, 4]))) {
F.line = 12;
